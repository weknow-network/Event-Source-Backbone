...
public record Metadata
{
    ...
    /// <summary>
    /// Gets or sets the operation's signature.
    /// </summary>
    public required OperationSignature Signature { get; init; }
    ...
    /// </returns>
    public override string ToString() => $"{EventKey}, {this.FullUri()}, {Signature}";
