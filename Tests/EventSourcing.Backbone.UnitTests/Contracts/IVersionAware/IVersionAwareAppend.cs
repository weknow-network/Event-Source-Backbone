namespace EventSourcing.Backbone.UnitTests.Entities
{
    ...
    [EventsContract(EventsContractType.Consumer, MinVersion = 1, VersionNaming = VersionNaming.Append, IgnoreVersion = new[] { 3 })]
    [Obsolete("This interface is base for code generation, please use ISimpleEventProducer or ISimpleEventConsumer", true)]
    public interface IVersionAwareAppend//: IVersionAwareBase
    {
