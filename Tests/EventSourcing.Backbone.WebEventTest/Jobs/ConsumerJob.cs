...
public sealed class ConsumerJob : IHostedService, IProductCycleConsumer
{
    ...
    {
        if (!consumerBuilderKeyed.TryGet(EventSourcingConstants.URI, out var consumerBuilder)) throw new EventSourcingException("consumer is missing DI");
    ...
    Task IHostedService.StartAsync(CancellationToken cancellationToken)
    {
        ...
        _subscription = _builder
                                .Group(EventSourcingConstants.CONSUMER_GROUP)
